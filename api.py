# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN 16.0 - CON LOGGING)
# Arquitectura con Carga "Perezosa" para Entornos Sin Estado
# ==============================================================================
...
# --- NUEVA SECCIÓN: Importaciones para el registro y tiempo ---
import csv
...
# Preparamos los clientes, pero no cargamos los datos aún
...
# --- NUEVA SECCIÓN: Configuración del archivo de registro ---
LOG_FILE = 'log.csv'
LOG_HEADERS = [
    'timestamp', 
    'user_id', 
...
def initialize_log_file():
    """Crea el archivo de registro con las cabeceras si no existe."""
...
def log_interaction(data):
    """Añade una nueva fila de datos al archivo de registro CSV."""
    with open(LOG_FILE, 'a', newline='', encoding='utf-8') as f:
        writer = csv.DictWriter(f, fieldnames=LOG_HEADERS)
        writer.writerow(data)

def cargar_y_verificar_cerebro():
    """Esta función ahora se llamará solo si es necesario."""
...
# --- MODIFICADO: La función ahora devuelve la respuesta Y el contexto ---
def ask_candidato_ia(pregunta):
    ...
    try:
        ...
        # Devolvemos ambos valores incluso en caso de error
...
def whatsapp_reply():
    # Registramos el tiempo de inicio para medir el rendimiento
    ...
    user_number = request.values.get('From', '') # Obtenemos el número del usuario
    print(f"Mensaje recibido de {user_number}: {incoming_msg}")
    
    resp = MessagingResponse()
    
    # --- MODIFICADO: Capturamos ambos valores de la función ---
    ...
    # --- NUEVA SECCIÓN: Lógica para registrar la interacción completa ---
    end_time = time.time()
    ...
    log_data = {
        ...
        'moderation_flags': "NOT_IMPLEMENTED", # Placeholder para futura implementación
...
# --- NUEVA SECCIÓN: Inicializar el archivo de registro al arrancar el servidor ---
initialize_log_file()