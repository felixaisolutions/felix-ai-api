# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN 21.0 - ROBUSTEZ "HUMANA")
# Introduce variabilidad en las respuestas de repliegue para evitar filtros anti-spam.
# ==============================================================================

import os
import re
import time
import random # Nueva importación para la aleatoriedad
...
# --- ARSENAL DE RESPUESTAS DE REPLIEGUE ---
FALLBACK_RESPONSES = [
...
# --- FUNCIÓN DE LOGGING ACUMULATIVO ---
...
def ask_candidato_ia(pregunta):
    ...
    # --- LÓGICA DE REPLIEGUE INTELIGENTE (MODIFICADA) ---
    ...
    Tu Misión: Dar la respuesta más completa y útil posible a la pregunta del ciudadano, basándote en la "Información de Apoyo".
    Instrucciones Clave:
    1.  Sintetiza y Conecta: Lee TODA la "Información de Apoyo" y conecta las diferentes ideas para dar una respuesta completa y natural.
    ...
    3.  GUARDARRAÍL DE REALIDAD: Construye tu respuesta usando únicamente las ideas y propuestas presentes en la "Información de Apoyo".
    4.  Brevedad Esencial: Sé conciso. Responde en un máximo de 2 o 3 párrafos cortos.
    5.  [IMPORTANTE] La "Regla de Oro" sobre no entender ya no es necesaria, se maneja fuera de este prompt. Si el contexto es relevante, úsalo para responder.
    ---
    ...
    try:
        ...
        try:
            ...
            if mod_response['results'][0]['flagged']:
                ...
                safe_response = "Entiendo que este es un tema de gran interés, pero mi enfoque principal está en las propuestas de mi plan de gobierno. ¿Hay algún aspecto de mi plan sobre seguridad, economía o desarrollo social que te gustaría discutir?"
