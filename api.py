...
# Arquitectura Sincronizada para Máxima Estabilidad en Render
# ==============================================================================
...
# --- CONFIGURACIÓN CON SINTAXIS ANTIGUA Y ESTABLE ---
...
def ask_candidato_ia(pregunta):
    ...
    Instrucciones Clave:
    1.  **Sintetiza y Conecta:** Lee TODA la "Información de Apoyo" para dar una respuesta completa.
    2.  **AUMENTA CON HECHOS:** Enriquece tu respuesta mencionando nombres de programas, cifras o datos específicos que encuentres.
    3.  **GUARDARRAÍL DE REALIDAD:** No introduzcas programas, planes o promesas nuevas que no estén en el texto.
    4.  **Regla de Oro:** Si la información es irrelevante, responde: "No estoy seguro de haber entendido bien tu pregunta. ¿Podrías reformularla?".
    ---
