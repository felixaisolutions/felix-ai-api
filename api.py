# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (v32.1 "MODO DEMO PERSONALIZABLE")
# Versión ultraligera y estable para demos, con el nombre del candidato
# centralizado para una fácil personalización.
# ==============================================================================
...
# --- [!!! PARÁMETRO DE PERSONALIZACIÓN CLAVE !!!] ---
# Cambia este nombre para adaptar el demo a cualquier candidato.
CANDIDATE_NAME = "Rodrigo Castrillón"
...
WELCOME_MESSAGE = f"""
¡Hola! Soy el Candidato Digital de {CANDIDATE_NAME}, un asistente de IA entrenado para responder tus preguntas sobre su plan de gobierno.

Estoy aquí para ayudarte 24/7. Pregúntame sobre cualquier de sus propuestas.
...
IDENTITY_FALLBACK_MESSAGE = f"""
Para ser completamente transparente contigo: soy el Candidato Digital, un agente de inteligencia artificial que actúa en nombre de {CANDIDATE_NAME}.

He sido entrenado con su plan de gobierno y su visión para responder de la manera más fiel posible a su pensamiento. Sin embargo, soy un programa informático y puedo cometer errores.
...
Documento Maestro de Campaña: Rodrigo Castrillón Gobernación

Fecha: 25 de agosto de 2025

De: Jefatura de Campaña

Asunto: Perfil Oficial y Plataforma de Gobierno del Candidato Rodrigo Castrillón

________________________________________

Perfil del Candidato

Nombre: Rodrigo Castrillón
...
Biografía: 
Rodrigo Alberto Castrillón fue elegido por primera vez como diputado del Quindío en octubre de 2019, consolidando así su llegada a la Asamblea Departamental para el periodo 2020–2023. Este ascenso representó un paso importante en su carrera política, pues le permitió ampliar su campo de acción hacia el conjunto del departamento, con la misión de legislar, ejercer control político y gestionar iniciativas que fortalecieran el desarrollo regional.



Antes de dar este salto, Castrillón ya contaba con una extensa y sólida trayectoria como dirigente local, marcada por su servicio como concejal de Armenia durante cuatro periodos consecutivos:



 2004–2007: inició su carrera política en el Concejo, destacándose por su cercanía con los barrios y comunidades más necesitadas. Durante este tiempo, impulsó debates sobre el acceso a servicios públicos y la participación ciudadana en la toma de decisiones locales.
 
 
 
 2008–2011: en su segundo periodo consolidó su liderazgo, con una agenda orientada al fortalecimiento de la infraestructura urbana y el acompañamiento a proyectos comunitarios en sectores vulnerables. Su trabajo comenzó a posicionarlo como un referente joven dentro del Partido Liberal.
 
 
 
 2012–2015: asumió un rol más activo en el control político, especialmente en temas relacionados con la transparencia administrativa y el uso eficiente de los recursos públicos. También promovió iniciativas para apoyar el deporte, la cultura y la inclusión social de jóvenes y mujeres.
 
 
 
 2016–2019: en su cuarto periodo, Castrillón se consolidó como uno de los concejales más representativos de Armenia. Entre sus gestiones destacaron el respaldo a proyectos de mejoramiento vial, la promoción de programas sociales dirigidos a adultos mayores y el fortalecimiento de la cooperación con organizaciones de base comunitaria. Su experiencia y la confianza ciudadana lograda durante este tiempo lo impulsaron a proyectarse hacia un escenario departamental.
 
 
 
Ya en la Asamblea Departamental, desde el 2020, Rodrigo Alberto Castrillón amplió su liderazgo hacia los distintos municipios del Quindío. En esta nueva etapa:



 Promovió el debate y la revisión detallada de los Planes de Desarrollo Departamental, insistiendo en la necesidad de que las inversiones llegaran no solo a la capital, sino también a los municipios cordilleranos y a las zonas rurales.
 
 
 
 Defendió la descentralización de programas sociales y de infraestructura, buscando que los beneficios del gobierno departamental fueran equitativos y respondieran a las realidades de cada territorio.
 
 
 
 Impulsó y acompañó proyectos orientados al fortalecimiento del turismo, como sector clave para la reactivación económica y la generación de empleo en la región.
 
 
 
 Respaldó iniciativas para la protección del Paisaje Cultural Cafetero, promoviendo un desarrollo económico que mantuviera el equilibrio entre productividad, identidad cultural y sostenibilidad ambiental.
 
 
 
 Se posicionó como un diputado cercano a las comunidades, manteniendo contacto directo con veredas y corregimientos, recogiendo sus necesidades y trasladándolas a los escenarios de decisión.
 
 
 
Con esta trayectoria, Rodrigo Alberto Castrillón se ha consolidado como un líder político con vocación de servicio y visión regional, que combina la experiencia adquirida en su gestión local con un compromiso renovado por la equidad, el bienestar social y la construcción de un Quindío más justo e inclusivo.



En el marco de la estrategia “Llévame en tu corazón”, el diputado liberal quindiano Rodrigo Alberto Castrillón ha consolidado un conjunto de programas sociales que buscan no solo atender necesidades inmediatas, sino también sembrar esperanza, dignidad y oportunidades de vida para los diferentes sectores de la población. Estas iniciativas reflejan un compromiso profundo con la comunidad y se convierten en un modelo de gestión social que trasciende la política para llegar al corazón de la gente.



 Celebrando mis 15: este programa ha permitido que jóvenes y mujeres adultas, quienes por diferentes circunstancias no tuvieron la oportunidad de celebrar sus quince años, puedan vivir este momento especial. Más que una fiesta, se trata de un espacio de inclusión y reconocimiento, donde se resalta la dignidad femenina, la alegría de compartir con la familia y la posibilidad de soñar sin importar la edad.
 
 
 
 Recuperando Sonrisas: la falta de acceso a servicios odontológicos y de rehabilitación oral afecta directamente la calidad de vida de muchas personas. Con esta iniciativa, Castrillón busca devolver la confianza, el bienestar y la autoestima a través de la entrega de prótesis dentales. Este programa impacta de manera positiva la salud, la integración social y las oportunidades laborales de quienes se benefician.
 
 
 
 Bienestar Contigo: en un contexto donde la salud mental se ha convertido en un desafío global, este programa abre espacios de escucha activa, orientación psicológica y acompañamiento emocional. Su propósito es brindar herramientas que fortalezcan el bienestar integral de mujeres, jóvenes y comunidades, reduciendo los índices de depresión, ansiedad y soledad que afectan el tejido social.
 
 
 
 Mi Primer Baby Kit: destinado a madres gestantes y a recién nacidos, este programa entrega kits básicos de cuidado que incluyen artículos de higiene, ropa y accesorios esenciales. Con ello se busca garantizar que los bebés tengan un inicio de vida seguro, digno y amoroso, al tiempo que se apoya a las madres en su rol de cuidadoras principales, fortaleciendo la maternidad responsable y protegida.
 
 
 
 Grupos de Adultos Mayores: orientado a quienes han entregado gran parte de su vida al desarrollo de la región, este programa fomenta actividades recreativas, culturales y de integración. Su objetivo es que las personas mayores vivan una vejez activa, saludable y acompañada, recuperando espacios de socialización y evitando el aislamiento.
 
 
 
 Mi Primera Comunión: en esta iniciativa, el diputado acompaña a niños y niñas de comunidades vulnerables en la celebración de este sacramento, proporcionándoles apoyo espiritual, logístico y emocional. Más allá de la ceremonia religiosa, el programa se convierte en una experiencia de unión familiar y fortalecimiento de valores.
 
 
 
 Todo empieza con un “Sí”: gracias a la organización de matrimonios colectivos, parejas que no cuentan con los recursos suficientes pueden formalizar su unión en ceremonias llenas de significado y amor. Este programa permite que la institucionalidad llegue de manera directa a la vida cotidiana de las familias, reforzando la importancia del compromiso y la construcción de hogares sólidos.
 
 
 
 Turismo Social: concebido como una forma de inclusión cultural, este programa abre la posibilidad de que comunidades con bajos recursos conozcan nuevos lugares, vivan experiencias de integración y fortalezcan la identidad regional. El turismo aquí se entiende no solo como recreación, sino también como una herramienta de aprendizaje, cohesión social y generación de sentido de pertenencia.
 
 
 
 Deporte para la vida: esta estrategia reconoce al deporte como una herramienta de transformación social. A través de actividades deportivas se promueven valores como la disciplina, la perseverancia, el respeto y el trabajo en equipo. Niños y jóvenes encuentran aquí una oportunidad de crecer en ambientes sanos, alejados de riesgos sociales, al tiempo que se potencia su talento y su integración comunitaria.
 
 
 
Cada uno de estos programas no solo responde a necesidades puntuales, sino que refleja una visión integral de desarrollo humano. En conjunto, constituyen una plataforma de bienestar social, inclusión y esperanza que impacta a la niñez, juventud, mujeres, adultos mayores y familias en general.



Con esta apuesta social, el diputado Rodrigo Alberto Castrillón reafirma que la política tiene un sentido real cuando se convierte en servicio, cercanía y compromiso con la gente. Su trabajo demuestra que es posible transformar vidas desde la acción comunitaria, llevando en el corazón la misión de construir un Quindío más equitativo, solidario y lleno de oportunidades para todos.
...
Rodrigo Castrillón es un líder con una trayectoria pública y privada impecable. Su experiencia no es un misterio; es el pilar de su capacidad para gobernar. A continuación, un resumen de su perfil y su compromiso con la transparencia.
...
Declaración de Renta: Rodrigo Castrillón ha publicado un resumen de su declaración de renta y bienes de 2024, demostrando su compromiso con la transparencia. Sus ingresos provienen exclusivamente de su actividad profesional como consultor. No posee contratos con el Estado, ni ha sido investigado por ningún órgano de control.

________________________________________

5.2. Aclaraciones y Rumores Comunes

En una campaña limpia, los rumores deben enfrentarse con la verdad. Rodrigo Castrillón no tiene nada que ocultar.

Rumor 1: "Rodrigo Castrillón es un empresario sin experiencia política".

Aclaración: La experiencia de Rodrigo es la de un gestor. Como Secretario de Desarrollo Económico de Armenia, lideró políticas públicas, gestionó presupuestos de más de $50.000 millones y supervisó a más de 100 funcionarios. Su enfoque no es el de un político de carrera, sino el de un líder que logra resultados.

Rumor 2: "Los recursos de la campaña de Castrillón provienen de grandes financiadores externos".
...
Marcela Pérez, Caficultora de Génova: "Cuando el precio del café se cayó, Rodrigo Castrillón fue el único que nos ayudó a crear una marca para venderlo a un mejor precio. Él sabe que nuestro futuro está en el campo, y no en la política de oficina."

Carlos Ochoa, Emprendedor Tecnológico de Armenia: "Gracias a los programas que Rodrigo impulsó cuando fue Secretario, mi empresa de software pudo crecer y hoy empleo a más de 20 jóvenes de la región. Él entiende que la tecnología es el futuro del Quindío."

Laura Torres, Líder Comunitaria de La Tebaida: "Rodrigo no es solo un candidato que viene a prometer. Él ha caminado nuestros barrios, conoce nuestras necesidades y, lo más importante, tiene un plan claro y detallado para la seguridad y el empleo de nuestra gente."
...
Redes Sociales: @rodrigoCastrillónGobernador (Instagram y Facebook).

Correo Electrónico: contacto@Rodrigocastrillon.com
...
def ask_candidato_ia(pregunta):
    ...
    try:
        ...
        return "Hubo un problema al consultar mi base de conocimiento."

    if contexto == "SIN_CONTEXTO":
        return random.choice(FALLBACK_RESPONSES)
    
    prompt_template = f"""
    Tu Persona: Eres el Candidato Digital de {CANDIDATE_NAME}. Tu propósito es actuar como su portavoz, comunicando sus propuestas de manera clara, conectada y humana. Responde siempre en primera persona como si fueras él ("Mi propuesta es...", "Creo firmemente...").
    ...
    1.  **MANEJO DE HECHOS BIOGRÁFICOS Y ACUSACIONES (Máxima Prioridad):**
        *   Si la pregunta es una afirmación o pregunta sobre un hecho personal (ej: "¿es cierto que fue futbolista?", "es usted corrupto"), y la "Información de Apoyo" **NO CONTIENE ESE HECHO**, tu primera oración DEBE ser una negación educada y directa.
        *   **SOLO DESPUÉS** de haber negado el hecho, puedes usar el contexto relevante para redirigir la conversación hacia sus propuestas reales.

    2.  **MANEJO DE PREGUNTAS DE OPINIÓN ("qué piensas de..."):**
        *   Si la pregunta pide una opinión sobre un tema amplio (ej: "drogadicción"), y el contexto no menciona esa palabra exacta pero sí temas relacionados (ej: "microtráfico", "juventud"), **USA ESOS TEMAS RELACIONADOS** para construir una respuesta que refleje la postura del candidato.

    3.  **SÍNTESIS Y PROFUNDIDAD (Comportamiento por Defecto):**
        *   Para todas las demás preguntas, tu objetivo es ser un excelente comunicador. **LEE TODO EL CONTEXTO** y **CONECTA LAS IDEAS** para dar una respuesta completa y elaborada.
    ...
    Respuesta como Portavoz de {CANDIDATE_NAME}:
    """
    try:
        ...
        return "Tuve un inconveniente al formular la respuesta."

# --- RUTA PRINCIPAL DE WHATSAPP (VERSIÓN LIGERA) ---
