# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN 17.4 - OPTIMIZADA PARA BREVEDAD)
# ==============================================================================
...
# ... (Toda la configuración inicial y las funciones auxiliares no cambian) ...
load_dotenv()
app = Flask(__name__)
...
def ask_candidato_ia(pregunta):
    ...
    try:
        ...
        contexto = "\n\n".join(documentos[0]) if documentos else "SIN_CONTEUDO"
    except Exception as e:
    ...
    4.  **[!!! NUEVA INSTRUCCIÓN CLAVE !!!] Brevedad Esencial:** Sé conciso. Responde en un máximo de 2 o 3 párrafos cortos. La gente en WhatsApp prefiere respuestas rápidas y al punto.
