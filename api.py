# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN 17.1 - ROBUSTA)
# ==============================================================================
...
# --- FUNCIONES (Sin cambios en su lógica interna) ---
...
def cargar_y_verificar_cerebro():
    ...
    global CEREBRO_CARGADO, collection
    print("Iniciando verificación y posible carga del cerebro...")
    campaign_document = """________________________________________
...
def ask_candidato_ia(pregunta):
    ...
    prompt_template = f"""... (tu prompt no cambia) ..."""
    try:
...
def whatsapp_reply():
    # --- MODIFICACIÓN CLAVE: AÑADIMOS UN BLOQUE TRY...EXCEPT GENERAL ---
    try:
        ...
        # Creamos una respuesta de emergencia
