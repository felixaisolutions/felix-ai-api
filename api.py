# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN FINAL Y ESTABLE)
# Arquitectura con Sintaxis Antigua de OpenAI para máxima compatibilidad
# ==============================================================================
...
import openai # Importamos la librería con la sintaxis antigua
import chromadb
...
# --- CONFIGURACIÓN CON SINTAXIS ANTIGUA ---
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")
if not OPENAI_API_KEY:
    raise ValueError("No se encontró la Clave API de OpenAI.")
openai.api_key = OPENAI_API_KEY # Así se configuraba antes

client_chroma = chromadb.PersistentClient(path="./chroma_db")
collection = client_chroma.get_or_create_collection(name="candidato_ia_final_stable")
...
Tu apoyo, tu voz y tus ideas son cruciales. Con tu participación, construiremos el Quindío que merecemos.
    ...
    if collection.count() != len(text_chunks):
        ...
        # Usamos la sintaxis antigua para los embeddings
...
def ask_candidato_ia(pregunta):
    contexto = ""
    try:
        # Usamos la sintaxis antigua para el embedding de la pregunta
    ...
    5.  **Regla de Oro:** Si la "Información de Apoyo" está vacía o es irrelevante, responde: "No estoy seguro de haber entendido bien tu pregunta. ¿Podrías reformularla de una manera más clara?".
    ---
    ...
    try:
        # Usamos la sintaxis antigua para la completación del chat
        res_completion = openai.ChatCompletion.create(
            model="gpt-4", # Usamos un modelo robusto
