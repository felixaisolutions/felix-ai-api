# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (RESTAURACIÓN a v29.0 "MAESTRO")
...
def classify_topic_api(query):
    categories = "Seguridad, Economía, Salud, Educación, Infraestructura, Social, Medio Ambiente, Finanzas de Campaña, Sobre el Candidado, Saludo/Otro"
