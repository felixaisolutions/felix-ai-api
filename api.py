# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN 17.0 - CON UPLOAD A HF)
# Arquitectura con Carga "Perezosa" y Sincronización de Logs
# ==============================================================================
...
# --- NUEVA SECCIÓN: Importaciones para la subida a Hugging Face ---
...
# --- NUEVA SECCIÓN: Configuración de Hugging Face ---
...
# Autenticar con Hugging Face al inicio
if HF_TOKEN:
...
LOG_FILE = 'log.csv'
LOG_HEADERS = [
    'timestamp', 'user_id', 'user_query', 'retrieved_context', 
    'ai_response', 'moderation_flags', 'response_time_ms'
]
...
# --- NUEVA SECCIÓN: Función para subir el log a Hugging Face ---
def upload_log_to_hf():
    """Sube el archivo log.csv completo al Dataset privado de Hugging Face."""
    ...
    try:
        ...
        # Es importante que un fallo en la subida no detenga la API principal
...
def whatsapp_reply():
    ...
    # --- MODIFICACIÓN CLAVE: Subimos el log después de cada interacción ---
    upload_log_to_hf()
