# ==============================================================================
# FELIX AI SOLUTIONS - API DEL CANDIDATO DIGITAL (VERSIÓN 19.0 - COMPLETA Y SEGURA)
# Incluye guardia de seguridad de moderación y corrección de 'SIN_CONTEXTO'.
# ==============================================================================
...
def cargar_y_verificar_cerebro():
    ...
    # [!!! ÚNICA ACCIÓN REQUERIDA: PEGA AQUÍ TU DOCUMENTO DE CAMPAÑA COMPLETO !!!]
    campaign_document = """
...
def ask_candidato_ia(pregunta):
    ...
    try:
        ...
        # [!!! CORRECCIÓN LÓGICA !!!] Aseguramos que se guarde 'SIN_CONTEXTO'
    ...
    5.  Regla de Oro: Si la información es irrelevante o no se encuentra, responde: "No estoy seguro de haber entendido bien tu pregunta. ¿Podrías reformularla de una manera más clara?".
    ---
...
# --- RUTA PRINCIPAL DE WHATSAPP (COMPLETA Y CON GUARDIA DE SEGURIDAD) ---
    ...
    try:
        ...
        try:
            ...
            if mod_response['results'][0]['flagged']:
                ...
                # Aún registramos la interacción para saber qué temas sensibles preguntan
                log_data = {'timestamp': datetime.utcnow().isoformat(), 'user_id': user_number, 'user_query': incoming_msg, 'retrieved_context': "MODERADO", 'ai_response': safe_response, 'moderation_flags': "FLAGEADO", 'response_time_ms': int((time.time() - start_time) * 1000)}
